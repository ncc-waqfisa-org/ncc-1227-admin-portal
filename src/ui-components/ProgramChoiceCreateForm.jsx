...
export default function ProgramChoiceCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setChoiceOrder(initialValues.choiceOrder);
    setErrors({});
  };
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(new ProgramChoice(modelFields));
          if (onSuccess) {
      ...
      {...rest}
      {...getOverrideProps(overrides, "ProgramChoiceCreateForm")}
    >
      <TextField
        label="Program id"
        isRequired={true}
