...
export default function MasterAppliedUniversitiesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new MasterAppliedUniversities(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MasterAppliedUniversitiesCreateForm")}
      {...rest}
    >
      <TextField
