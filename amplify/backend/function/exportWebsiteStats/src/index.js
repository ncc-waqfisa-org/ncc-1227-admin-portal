...
exports.handler = async (event) => {
    ...
    try {
        ...
        const notCompletedApplications = await getNotCompletedApplications(applications);
        const signedUpButNoApplicationStudents = await getSignedUpButNoApplicationStudents(applications, students);
...
async function getNotCompletedApplications(applications) {
    const notCompletedApplications = applications.filter(app => app.status === 'NOT_COMPLETED');
